...
.plan-lite { background: rgba(245,158,11,0.2); color: #92400e; }
.plan-pro { background: rgba(99,102,241,0.2); color: #3730a3; }
.plan-ultimate { background: rgba(168,85,247,0.2); color: #5b21b6; }
.plan-inactive { background: rgba(239,68,68,0.2); color: #991b1b; }
.logout-btn {
