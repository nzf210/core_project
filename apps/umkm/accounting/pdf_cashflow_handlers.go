...
func writeCashFlowHeader(pdf *gofpdf.Fpdf, d cashFlowRenderData) {
...
func writeCashFlowSections(pdf *gofpdf.Fpdf, d cashFlowRenderData) {
...
func writeCashFlowFooter(pdf *gofpdf.Fpdf) {
