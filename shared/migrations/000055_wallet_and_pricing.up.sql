...
INSERT INTO addon_prices (addon_key, price_rupiah, unit) VALUES
...
CREATE TABLE wallet_credits (
    ...
    balance_rupiah BIGINT NOT NULL DEFAULT 0,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE wallet_transactions (
    ...
    amount_rupiah BIGINT NOT NULL, -- positive for topup, negative for consumption
